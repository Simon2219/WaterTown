// Assets/ScriptableObjects/Platform Data/PlatformBlueprint.cs
...
/// - Default socket channels for new sockets
...
public class PlatformBlueprint : ScriptableObject
    {
        ...
        [Tooltip("Default channels assigned to newly built sockets on this platform type.")]
        [SerializeField] private GamePlatform.LinkChannel defaultSocketChannels = GamePlatform.LinkChannel.Walk;
        ...
        public GamePlatform.LinkChannel DefaultSocketChannels => defaultSocketChannels;
